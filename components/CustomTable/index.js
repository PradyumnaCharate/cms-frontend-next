...
export default function CustomTable({column,isSearch=true,searchPlaceholder,title,createOnClick,createText,loading,query,setQuery,children,resultPerPage=10,paging=false,numOfPages=1,pageHandler,curPage=1}) {
  


  const len = column?.length;
  return (
    <Card className=" mt-2 rounded-3 border-0">
...
export const ViewButton = ({ onClick }) => {
  return (
    <Button variant="transparent" className="p-0 mx-1 "
     onClick={onClick} 
     >
